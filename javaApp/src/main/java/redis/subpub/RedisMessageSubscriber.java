...
class MyBinaryJedisPubSub extends BinaryJedisPubSub {

    final static Logger logger = LoggerFactory.getLogger(MyBinaryJedisPubSub.class);
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            jedis.subscribe(new MyBinaryJedisPubSub(), channel);
                        } catch (Exception e) {
                            e.printStackTrace();
